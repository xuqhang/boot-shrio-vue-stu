	  ...
	  <el-row>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" plain @click="exportUser">导出表格</el-button>
				</el-form-item>
				<el-form-item>
					<el-button type="infor" round @click="exportUserByA">导出</el-button>
				</el-form-item>
				<el-form-item>
		...
		methods: {
          ...
          this.delUsers()
			...
			exportUser () {
				axios({
					  method: 'post',
					  url: 'http://localhost:8089/user/export',
					  data: {
			...
			exportUserByA () {
				...
				const link = document.createElement('a')
				link.href = "http://localhost:8089/user/export?username="+username
				document.body.appendChild(link)
				link.click()
				document.body.removeChild(link)
